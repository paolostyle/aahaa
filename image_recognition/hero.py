...
from .color_tools import get_dominant_color, color_difference
...
class HeroIconSections(object):
    def __init__(self, loc, base_img):
        ...
        self.level = base_img[loc[1] - 31 : loc[1], loc[0] : loc[0] + 97]
...
class HeroCopy(object):
    ...
    def __set_stars(self):
        if self.data["ascension"] == "Ascended":
...
class Hero(object):
    ...
    def create_match(self, icon_sections: HeroIconSections, location):
        hero_data = omit(self.__hero_data, {"filename"})
